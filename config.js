...
global.location = "Lahore,Pakistan,united kingdom,nigeria,united state.";
global.mongodb = process.env.MONGODB_URI || "";
global.allowJids = process.env.ALLOW_JID || "null";
global.blockJids = process.env.BLOCK_JID || "null";
global.DATABASE_URL = process.env.DATABASE_URL || "";
global.timezone = process.env.TZ || process.env.TIME_ZONE || "Africa/Lagos";
global.github = process.env.GITHUB || "https://github.com/OFFICIAL-KY-MD";
...
module.exports = {
  ...
  caption: process.env.CAPTION || "𝐅𝐈𝐋𝐄-𝐆𝐄𝐍𝐄𝐑𝐀𝐓𝐄𝐃-𝐁𝐘-OFFICIAL_KY-𝐌𝐃😍",
  author: process.env.PACK_AUTHER || "KY",
  packname: process.env.PACK_NAME || "KY",
  botname: process.env.BOT_NAME || "OFFICIAL_KY-𝐌𝐃",
  ownername: process.env.OWNER_NAME || "OFFICIAL",
  errorChat: process.env.ERROR_CHAT || "8132770719",
